...
**Run 2, the mixed run, launched 16:51 the same day, job `32ooy2w`:** same real data, plus ATCOSIM (7,640 clips), plus 2,400 of our own simulator clips in eight other macOS voices. Six epochs, about 4,000 steps. Validation and the 1,000 held-out real clips are the same clips as run 1. It also reports stock versus tuned on the 299 simulator clips above and on ATCOSIM's test split. Fill in the result here.
